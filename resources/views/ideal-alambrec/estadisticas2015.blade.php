    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          ...
          vAxis: {title: 'Total Penetración',  titleTextStyle: {color: 'red'}}
        };
      ...
      function drawTable() {
              ...
              data.addRows([
                ...
                ['ADELCA',  "{{ countProductos('clavos_adelca') }}", "{{ countProductos('alambres_adelca') }}", "{{ countProductos('alambres_puas_adelca') }}", "{{ countProductos('mallas_cerramiento_adelca') }}", "", "{{ countProductos('barras_adelca') }}", "{{ countProductos('electro_adelca') }}", "{{ countProductos('vigas_adelca') }}", "{{ $adelca }}"],
                ['ANDEC',  "", "", "", "", "", "{{ countProductos('barras_andec') }}", "{{ countProductos('electro_andec') }}", "{{ countProductos('vigas_andec') }}", "{{ $andec }}"],
                ['NOVACERO',  "{{ countProductos('clavos_novacero') }}", "", "", "", "", "{{ countProductos('barras_novacero') }}", "{{ countProductos('electro_novacero') }}", "{{ countProductos('vigas_novacero') }}", "{{ $novacero }}"],
                ['IPAC',  "", "", "", "", "", "{{ countProductos('barras_ipac') }}", "", "", "{{ $ipac }}"],
      ...
      function drawTable4() {
        ...
        data.addRows([
          ...
          ['ADELCA',  "{{ porcentaje(countProductos('clavos_adelca'), $total_puntos_visitados) }}%", "{{ porcentaje(countProductos('alambres_adelca'), $total_puntos_visitados) }}%", "{{ porcentaje(countProductos('alambres_puas_adelca'), $total_puntos_visitados) }}%", "{{ porcentaje(countProductos('mallas_cerramiento_adelca'), $total_puntos_visitados) }}%", "", "{{ porcentaje(countProductos('barras_adelca'), $total_puntos_visitados) }}%", "{{ porcentaje(countProductos('electro_adelca'), $total_puntos_visitados) }}%", "{{ porcentaje(countProductos('vigas_adelca'), $total_puntos_visitados) }}%", "{{ porcentaje($adelca, $total_puntos_visitados) }}%"],
          ['ANDEC',  "", "", "", "", "", "{{ porcentaje(countProductos('barras_andec'), $total_puntos_visitados) }}%", "{{ porcentaje(countProductos('electro_andec'), $total_puntos_visitados) }}%", "{{ porcentaje(countProductos('vigas_andec'), $total_puntos_visitados) }}%", "{{ porcentaje($andec, $total_puntos_visitados) }}%"],
          ['NOVACERO',  "{{ porcentaje(countProductos('clavos_novacero'), $total_puntos_visitados) }}%", "", "", "", "", "{{ porcentaje(countProductos('barras_novacero'), $total_puntos_visitados) }}%", "{{ porcentaje(countProductos('electro_novacero'), $total_puntos_visitados) }}%", "{{ porcentaje(countProductos('vigas_novacero'), $total_puntos_visitados) }}%", "{{ porcentaje($novacero, $total_puntos_visitados) }}%"],
          ['IPAC',  "", "", "", "", "", "{{ porcentaje(countProductos('barras_ipac'), $total_puntos_visitados) }}%", "", "", "{{ porcentaje($ipac, $total_puntos_visitados) }}%"],
